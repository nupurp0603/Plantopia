      ...
      >
        ...
        >
          ...
          <View style={s.panel}>
            ...
            <Text style={s.subheading}>Start your plant care journey</Text>

            {/* Name */}
            <View style={s.inputRow}>
              <Ionicons name="leaf-outline" size={20} color="rgba(255,255,255,0.65)" style={s.inputIcon} />
              <TextInput
                style={s.input}
            ...
            {/* Create Account */}
            <TouchableOpacity
              style={[s.primaryBtn, loading && { opacity: 0.7 }, { marginTop: 8 }]}
            ...
            <View style={s.bottomRow}>
              <Text style={s.bottomMuted}>Already have an account? </Text>
